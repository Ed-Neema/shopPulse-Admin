...
const Nav = ({show}) => {
  const inactiveLink = "flex gap-1 px-2 py-1.5";
  const activeLink = inactiveLink + " bg-highlight text-primary font-bold rounded-md";
  ...
  return (
    <aside
      className={
        ...
        " top-0 text-gray-500 border-r p-4 fixed z-10 w-full bg-bgGray h-full md:static md:w-auto transition-all"
      }
    >
